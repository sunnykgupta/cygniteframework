 ...
 *
 */
 Cygnite::loader()->logger->write('Assets class Initialized',__FILE__,'debug');
...
class Assets
{
    ...
    */
    ...
    public static function ajax($url,$data,$method,$callback,$call_type = '')
    {
            $ajax_script = '';
...
class HTML
{
    ...
    */
    public function sanitize($value,$type='')
    {
        switch($type):
            case 'strong':
                 return htmlentities($value, ENT_QUOTES | ENT_IGNORE,Config::getconfig('global_config','encoding'));
            break;
            case 'strict':
                 return urlencode($value);
            break;
            default:
                 return htmlspecialchars($value, ENT_QUOTES,Config::getconfig('global_config','encoding'));
            break;
        endswitch;
    }
}